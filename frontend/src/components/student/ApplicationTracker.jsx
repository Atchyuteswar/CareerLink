...
const ApplicationTracker = () => {
    ...
    const handleWithdraw = async (appId) => {
        ...
        try {
            const res = await axios.post(`http://localhost:8000/api/v1/application/withdraw/${appId}`, {}, { withCredentials: true });
            if (res.data.success) {
    ...
    const handleSaveNote = async (appId) => {
        try {
            const res = await axios.post(`http://localhost:8000/api/v1/application/note/${appId}`, { note: noteText }, { withCredentials: true });
            if (res.data.success) {
