...
const CompanySetup = () => {
    ...
    useEffect(() => {
        const fetchCompany = async () => {
            try {
                const res = await axios.get(`https://careerlink-1ank.onrender.com/api/v1/company/get/${params.id}`, {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`https://careerlink-1ank.onrender.com/api/v1/company/update/${params.id}`, formData, {
