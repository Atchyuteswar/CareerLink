...
const PostJob = () => {
    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                const res = await axios.get("http://100.94.122.76:8000/api/v1/company/get", { withCredentials: true });
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.post("http://100.94.122.76:8000/api/v1/job/post", input, {
